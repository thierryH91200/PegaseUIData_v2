...
struct ContentView: View {
    ...
    private func applyWindowProfile(isSplash: Bool, animated: Bool) {
        ...
        if isSplash {
            window.contentMinSize = UIConstants.splashScreenMinSize
            window.contentMaxSize = UIConstants.splashScreenMaxSize
        } else {
            window.contentMinSize = UIConstants.mainWindowMinSize
            window.contentMaxSize = UIConstants.mainWindowMaxSize
        }
