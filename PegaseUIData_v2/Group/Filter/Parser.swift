...
//        let defaultFormat = "amount >= 100" //
    ...
    func applyPredicate(_ predicate: NSPredicate?) {
        do {
            ...
            print("❌ Filtre refusé :", error.localizedDescription)
            self.predicate = nil
        }
    }
...
//        }
    ...
    func swiftDataPredicate(from ns: NSPredicate?) -> Predicate<EntityTransaction>? {
        ...
        print("NSPredicate reçu :", predicate?.predicateFormat ?? "nil")
...
//    var filtered: [EntityTransaction] {
