...
struct DGLineChartRepresentable: NSViewRepresentable {
    ...
    /// Called when a day is selected on the chart. Provides the filtered transactions for that day.
    /// Pass nil to indicate deselection (restore to slider-filtered transactions).
    var onSelectDay: (([EntityTransaction]?) -> Void)? = nil
    ...
    static func dismantleNSView(_ nsView: LineChartView, coordinator: Coordinator) {
        ...
        DispatchQueue.main.async {
            ...
            // Notify to restore slider-filtered transactions
            parent.onSelectDay?(nil)
        }
    }
...
//        allTransactions.sort { $0.datePointage < $1.datePointage }
        ...
        // Mise à jour de la liste du viewModel (pour le calcul du graphique)
        DispatchQueue.main.async {
    ...
    final class Coordinator: NSObject, ChartViewDelegate {
        ...
        public func chartValueSelected(_ chartView: ChartViewBase, entry: ChartDataEntry, highlight: Highlight) {
            ...
            let work = DispatchWorkItem { [weak self] in
                ...
                Task { @MainActor in
                    // Notify SwiftUI parent to update filteredTransactions locally
                    self.parent.onSelectDay?(selectTransactions)
                }
            }
        ...
        public func chartValueNothingSelected(_ chartView: ChartViewBase)
        {
            ...
            let work = DispatchWorkItem { [weak self] in
                ...
                Task { @MainActor in
                    ...
                    // Notify SwiftUI parent to restore slider-filtered transactions
                    self.parent.onSelectDay?(nil)
                }
            }
